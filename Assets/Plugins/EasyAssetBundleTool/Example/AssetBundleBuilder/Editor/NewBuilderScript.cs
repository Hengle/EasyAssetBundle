...
[CreateAssetMenu]
public class NewBuilderScript: EasyAssetBundleBuilderData {
    ...
    public override void SaveAssetBundleList( List<EditorAssetInfo> versionAsset, string savePath ) {
        ...
        //sb.Append( "FileName,AssetPath,AssetBundle,Extension,Version,Size,Date" );
        //sb.Append( "\n" );
    ...
    /// Convert EditorAssetInfo to your custom assetbundleList.
    /// </summary>
    public override void ConvertAssetBundleList( List<EditorAssetInfo> versionAssets, string savePath ) {
        throw new NotImplementedException();
    }
